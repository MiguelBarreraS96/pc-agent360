/** Generated from bootstrap-icons/font/bootstrap-icons.json (v1.11.3). Do not hand-edit; regenerate if the bootstrap-icons dependency version changes. */

/** Every available Bootstrap Icons glyph name, without the "bi-" prefix, in alphabetical order. */
...
/** A curated subset of icons relevant to insurance/financial products, shown before the admin searches. */
export const POPULAR_BOOTSTRAP_ICON_NAMES: readonly string[] = [
  "car-front",
  "truck",
  "bicycle",
  "airplane",
